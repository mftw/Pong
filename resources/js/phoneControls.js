// Detect if the game is running on mobile device
...
var mobileAndTabletcheck = isMobileDevice();
...
if(mobileAndTabletcheck || forceMobile) {
    // Stop pinacolada dance
    tl.pause()
    tl1.pause()
    
    // Hide those drinks!
    let pinacoladaLeft = document.getElementById('pinaCola_x5F_left');
    let pinacoladaRight = document.getElementById('pinaCola_x5F_right');

    pinacoladaLeft.style.display =  'none';
    pinacoladaRight.style.display = 'none';

    // Show them your nice buttons
    let leftConsole = document.getElementById('leftConsole');
    let rightConsole = document.getElementById('rightConsole');

    leftConsole.style.display = 'block';
    rightConsole.style.display = 'block';

    // get the touch control buttons
    let p1TouchKeyUp = document.getElementById('upCon');
    let p1TouchKeyDown = document.getElementById('downCon');
